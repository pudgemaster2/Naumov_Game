      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="gothic-panel p-5 bg-slate-100/90 border-slate-300 rounded-lg flex flex-col items-center text-center text-slate-800">
            <h3 className="text-base font-bold font-gothic text-slate-900">Жрец Селестиан</h3>
            <p className="text-xs text-slate-650 mt-2 italic leading-relaxed">
          ...
          {/* Temple Dialogue log */}
          {templeLog && (
            <div className="p-4 border border-blue-300 rounded bg-blue-50 text-xs text-blue-800 font-serif leading-relaxed animate-fade-in flex gap-2">
              <MessageSquare className="w-4 h-4 flex-shrink-0 text-blue-500 mt-0.5" />
              <span>{templeLog}</span>
            </div>
          )}
        </div>
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="gothic-panel p-6 bg-slate-100/90 border-slate-300 rounded-lg space-y-4 text-slate-800">
            <h3 className="text-base font-bold font-gothic text-slate-900 border-b border-slate-250 pb-2">
              Священные Обряды
            </h3>
            ...
            <div className="space-y-4">
              ...
              <div className="border border-slate-250 p-4 rounded bg-slate-50/50 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-slate-900">Омовение Целебным Источником</h4>
                    <p className="text-xs text-slate-650 mt-1">Очистите тело от ядов и исцелите раны. Полностью восстанавливает HP.</p>
                  </div>
                </div>
                
                <div className="flex items-center gap-4">
                  <span className="font-mono text-xs font-bold text-amber-700">💰 5 золота</span>
                  <Button 
                    onClick={handleHeal} 
                    disabled={isCasting}
                    size="sm"
              ...
              <div className="border border-slate-250 p-4 rounded bg-slate-50/50 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-start gap-3">
                  <div className="p-2.5 bg-blue-50 border border-blue-200 text-blue-700 rounded">
                    <Sparkles className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-slate-900">Благословение Интеллекта</h4>
                    <p className="text-xs text-slate-650 mt-1">Жрец озаряет ваш ум священным песнопением. Наполняет разум силой магии.</p>
                    <span className="inline-block mt-1 text-[10px] text-sky-800 font-bold bg-sky-50 border border-sky-200 px-2 py-0.5 rounded">
                ...
                <div className="flex items-center gap-4">
                  <span className="font-mono text-xs font-bold text-amber-700">💰 15 золота</span>
                  <Button 
              ...
              <div className="border border-slate-250 p-4 rounded bg-slate-50/50 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-start gap-3">
                  <div className="p-2.5 bg-amber-50 border border-amber-200 text-amber-700 rounded">
                    <RefreshCw className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-slate-900">Сброс Улучшений (Ритуал Очищения)</h4>
                    <p className="text-xs text-slate-650 mt-1">Очистить снаряжение от улучшений кузнеца и вернуть потраченное на них золото.</p>
                  </div>
                </div>
                
                <div className="flex items-center gap-4">
                  <span className="font-mono text-xs font-bold text-amber-700">💰 10 золота</span>
                  <Button 
