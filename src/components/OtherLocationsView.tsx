    ...
    switch (locationKey) {
        ...
        return (
          <div className="gothic-panel p-6 bg-obsidian-900/80 rounded-lg space-y-6">
            <h3 className="text-lg font-bold font-gothic text-gold-400 border-b border-obsidian-800 pb-2 flex items-center gap-2">
              <Shield className="w-5 h-5 text-gold-500" /> Караульный пост у Ворот
            </h3>
            ...
            <div className="flex flex-col items-center p-6 border border-obsidian-800 rounded bg-obsidian-950/40 text-center space-y-4">
              {isPatrolling ? (
                <div className="space-y-3">
                  <div className="w-16 h-16 bg-gold-950/20 text-gold-500 border border-gold-900/30 rounded-full flex items-center justify-center text-xl font-bold animate-pulse mx-auto">
                    {patrolTimeLeft}с
                  </div>
                  <div className="text-xs text-slate-400 font-mono">Обход периметра стен...</div>
                  <div className="w-48 h-1 bg-obsidian-900 rounded overflow-hidden">
                    <div 
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-slate-200">Дозор на Стенах</h4>
                    <p className="text-[11px] text-slate-500 mt-0.5">Время дозора: 5 секунд. Награда: 💰 15 золота.</p>
                  </div>
                  <Button 
      ...
      case 'siege':
        return (
          <div className="gothic-panel p-6 bg-obsidian-900/80 rounded-lg space-y-6">
            <h3 className="text-lg font-bold font-gothic text-gold-400 border-b border-obsidian-800 pb-2 flex items-center gap-2">
              <Target className="w-5 h-5 text-gold-500" /> Осадный Расчет Катапульты
            </h3>
            ...
            <div className="flex flex-col items-center p-6 border border-obsidian-800 rounded bg-obsidian-950/40 text-center space-y-4">
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-200">Произвести Выстрел по Окрестностям</h4>
                <p className="text-[11px] text-slate-500 mt-0.5">Испытайте удачу. Случайная награда: золото или боевой опыт.</p>
              </div>
              <Button 
      ...
      case 'post':
        return (
          <div className="gothic-panel p-6 bg-obsidian-900/80 rounded-lg space-y-6">
            <h3 className="text-lg font-bold font-gothic text-gold-400 border-b border-obsidian-800 pb-2 flex items-center gap-2">
              <Timer className="w-5 h-5 text-gold-500" /> Плац Оборонительного Поста
            </h3>
            ...
            <div className="flex flex-col items-center p-6 border border-obsidian-800 rounded bg-obsidian-950/40 text-center space-y-4">
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-200">Боевой Тренировочный Спарринг</h4>
                <p className="text-[11px] text-slate-500 mt-0.5">Стоимость: 💰 10 золота. Награда: ⭐ +25 Опыта (XP).</p>
              </div>
              <Button 
                onClick={handleTrain}
      ...
      case 'upper_tier':
        return (
          <div className="gothic-panel p-6 bg-obsidian-900/80 rounded-lg space-y-6">
            <h3 className="text-lg font-bold font-gothic text-gold-400 border-b border-obsidian-800 pb-2 flex items-center gap-2">
              <HelpCircle className="w-5 h-5 text-gold-500" /> Дерево Старейшин (Верхний Ярус)
            </h3>
            ...
            <div className="border border-obsidian-800 p-5 rounded bg-obsidian-950/40 space-y-4">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-obsidian-900 border border-gold-600/30 rounded-full flex items-center justify-center text-3xl shadow-[inset_0_2px_5px_rgba(0,0,0,0.8)] select-none">
                  👴
                </div>
                <div>
                  <h4 className="text-sm font-bold text-slate-200 font-gothic">Архивариус Элронд</h4>
                  <p className="text-[10px] text-slate-500 uppercase tracking-widest font-mono">Старейшина города</p>
                </div>
              </div>
              
              <div className="p-4 border-l-2 border-gold-500 bg-obsidian-900/50 rounded-r text-xs text-slate-300 italic font-serif leading-relaxed space-y-2">
              ...
              <div className="flex justify-end font-mono text-[10px] text-slate-500">
                Уровень вашего героя: {player.level} | Класс: {player.classType === 'barbarian' ? 'Силач' : player.classType === 'mage' ? 'Маг' : 'Лучник'}
              </div>
            </div>
          </div>
        );
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="gothic-panel p-5 bg-obsidian-900/80 rounded-lg flex flex-col items-center text-center">
            <div className="w-20 h-20 bg-obsidian-950 border border-gold-600/30 rounded-full flex items-center justify-center text-4xl mb-4 relative shadow-[inset_0_4px_10px_rgba(0,0,0,0.8)]">
              🏰
            </div>
            
            <h3 className="text-base font-bold font-gothic text-slate-200">Эльфийская Цитадель</h3>
            ...
            <div className="w-full mt-2 p-3 bg-obsidian-950 border border-obsidian-800 rounded font-mono text-xs flex justify-between items-center text-slate-300">
              <span>Опыт (XP):</span>
              <span className="text-gold-400 font-bold">⭐ {player.experience}</span>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          {/* Activity log */}
          {log && (
            <div className="p-4 border border-gold-900/30 rounded bg-gold-950/10 text-xs text-gold-300 font-serif leading-relaxed whitespace-pre-line animate-fade-in flex items-start gap-2">
